...
Deno.serve(async (req: Request) => {
  try {
    ...
    const prompt = `You are a helpful assistant that breaks down big tasks into simple, clear
subtasks. Given a main task, return a list of 5 to 7 clear, short subtasks
